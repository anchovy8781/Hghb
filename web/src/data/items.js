...
(function (global) {
  ...
  const ITEMS = [
    ...
    { id: 'pistol',   name: '권총',          kind: 'gun', val: 3, gun: 'pistol', caliber: '9mm', weapon: 2 },
    { id: 'shotgun',  name: '산탄총',        kind: 'gun', val: 3, gun: 'sg', caliber: '12g', weapon: 3 },
    { id: 'rifle',    name: '조립식 저격소총', kind: 'gun', val: 3, gun: 'sr', caliber: '762', weapon: 3 },
    { id: 'knife',    name: '회칼',          kind: 'part', val: 1, weapon: 1 },
    { id: 'pipe',     name: '쇠파이프',      kind: 'part', val: 1, weapon: 1 },
    { id: 'shell',    name: '산탄',          kind: 'ammo', val: 1, caliber: '12g' },
    { id: 'bullet',   name: '소총탄',        kind: 'ammo', val: 1, caliber: '762' },
