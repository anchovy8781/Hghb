...
(function (global) {
  ...
  const MORE = [
    ...
    { id: 'cpu',       name: '고성능 중앙처리장치', kind: 'part', val: 3, set: 'pc', note: '핀이 하나도 안 휘었다.' },
    ...
    { id: 'usb',       name: '유에스비 메모리',      kind: 'doc', val: 2, note: '안에 뭐가 들었는지는 읽을 데가 있어야 안다.' },
    { id: 'rccar',     name: '무선 조종차',     kind: 'lux', val: 2, mp: 1, note: '건전지만 있으면 아직 달린다.' },
