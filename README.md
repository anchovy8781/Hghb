...
가는 길에 손으로 쓴 **특별 이야기 56편**이 판마다 다른 순서로 끼어들고,
...
| 특별 이야기 | 손으로 쓴 단편·중편 **56편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 56편을 통째로 셔플해 두고,
...
- **특별 이야기 56편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
```
$ node tools/simulate.mjs 3 700
템플릿 148 · 도입 변형 444 · 선택지 603

시드 700 · 275p · 3장까지 · 장면 275 · 고유 도입 256 · 중복 0 · 본문 8.3만자 · 엔딩 길 위에서
   특별 이야기 12/56편 · 칭호 6개 (열아홉 번째 사람, 단골, 김씨의 친구)
시드 1677 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1122 · 중복 0 · 본문 37.0만자 · 엔딩 침묵
   특별 이야기 56/56편 · 칭호 26개 (김씨의 친구, 때 미는 사람, 부학생회장)
시드 2654 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1122 · 중복 0 · 본문 36.6만자 · 엔딩 재판
   특별 이야기 56/56편 · 칭호 24개 (백예순여덟, 때 미는 사람, 김씨의 친구)

통과 3/3 — 중복 본문 없음

세 번 맞으면 죽기 때문에 끝까지 가는 판이 절반쯤 됩니다. 죽는 판도 정상 결과입니다.
```
