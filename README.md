...
가는 길에 손으로 쓴 **특별 이야기 32편**이 판마다 다른 순서로 끼어들고,
...
한 판은 **1,200페이지**이고, 본문은 약 **31만 자**입니다. (짧은 페이지 5,000장보다 읽는 분량이 많습니다.)
...
| 특별 이야기 | 손으로 쓴 단편·중편 **32편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
| 칭호 | 「단골」 「산 사람」 「열아홉 번째 사람」 … 칭호가 있어야만 열리는 사건이 7종 따로 있다 |
| 사망 | 체력 0 · 멘탈 0 · 피폭 4. 다만 **의약품 · 의료용 주사기 · 생명의 부적**이 있으면 그 자리에서 한 번 되살아난다 |
| 종장 | 진행도 100%(1,200페이지)에 닿으면 종장이 열리고, 그동안 쌓은 단서와 특별 이야기 편수에 따라 엔딩이 갈린다 |

### 체력·멘탈이 실제로 깎이도록

한 칸은 네 눈금이고, 선택지의 `-1` 은 두 눈금(반 칸)을 깎는다. 두 번 잘못 고르면 한 칸이 빈다.
...
- 결과: **생성 2,623종 + 손으로 쓴 142종 = 2,765종**
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 32편을 통째로 셔플해 두고,
...
- **특별 이야기 32편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
1. **템플릿 덱** — 사건 템플릿 119종을 비복원으로 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
2. **슬롯 조합** — 구역 20 · 장소 52 · 인물 이름 1,200 · 유형 16 · 특징 24 · 위협 16 · 아이템 2,765 를 각각 별도의 덱에서 뽑아 끼운다.
...
```
$ node tools/simulate.mjs 2 300
템플릿 119 · 도입 변형 357 · 선택지 429

시드 300 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1141 · 중복 0 · 본문 31.2만자 · 엔딩 복수
   긴장 12종 · 유머 10종 · 잡동사니 보상 12종 · 칭호 사건 5종 · 만든 물건 4개
   특별 이야기 32/32편 · 칭호 17개 (산 사람, 열아홉 번째 사람, 때 미는 사람)
시드 1277 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1141 · 중복 0 · 본문 31.2만자 · 엔딩 복수
   긴장 12종 · 유머 10종 · 잡동사니 보상 10종 · 칭호 사건 5종 · 만든 물건 8개
   특별 이야기 32/32편 · 칭호 22개 (순회 단원, 서명한 사람, 새벽 사람)
