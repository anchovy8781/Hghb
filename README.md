...
가는 길에 손으로 쓴 **특별 이야기 72편**이 판마다 다른 순서로 끼어들고,
...
| 가젯 | 능력 **55종**과 아이템 **3,213종**을 하나로 취급 |
...
| 특별 이야기 | 손으로 쓴 단편·중편 **72편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
- 결과: **생성 2,623종 + 손으로 쓴 590종 = 3,213종**
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 72편을 통째로 셔플해 두고,
...
- **특별 이야기 72편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
1. **템플릿 덱** — 사건 템플릿 183종을 비복원으로 뽑는다. 최근 **32개** 안에 나온 사건은 다시 안 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
...
템플릿 183 · 도입 변형 549 · 선택지 777

시드 100  · 1203p · 본문 39.7만자 · 엔딩 침묵
시드 1077 · 527p  · 본문 17.7만자 · 엔딩 무너짐   ← 도중에 죽은 판
시드 2054 · 1203p · 본문 39.9만자 · 엔딩 기록자
시드 3031 · 1203p · 본문 39.8만자 · 엔딩 기록자
시드 4008 · 1203p · 본문 39.8만자 · 엔딩 불
시드 4985 · 1203p · 본문 39.5만자 · 엔딩 기록자

통과 6/6 — 중복 본문 없음
장면 1,203개 중 도입 문단이 겹치지 않는 것이 1,120개, 완전히 같은 본문은 0개.
```
