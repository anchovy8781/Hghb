...
가는 길에 손으로 쓴 **특별 이야기 46편**이 판마다 다른 순서로 끼어들고,
...
| 가젯 | 능력 **55종**과 아이템 **3,083종**을 하나로 취급 |
...
| 특별 이야기 | 손으로 쓴 단편·중편 **46편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
- 결과: **생성 2,623종 + 손으로 쓴 460종 = 3,083종**
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 46편을 통째로 셔플해 두고,
...
- **특별 이야기 46편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
1. **템플릿 덱** — 사건 템플릿 140종을 비복원으로 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
2. **슬롯 조합** — 구역 20 · 장소 52 · 인물 이름 1,200 · 유형 16 · 특징 24 · 위협 16 · 아이템 3,083 을 각각 별도의 덱에서 뽑아 끼운다.
...
템플릿 140 · 도입 변형 420 · 선택지 552

시드 700 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1141 · 중복 0 · 본문 36.2만자 · 엔딩 기록자
   긴장 12종 · 유머 10종 · 잡동사니 보상 7종 · 칭호 사건 5종 · 만든 물건 7개
   특별 이야기 46/46편 · 칭호 20개 (이모의 친구, 열아홉 번째 사람, 불 켜는 사람)
시드 1677 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1141 · 중복 0 · 본문 36.3만자 · 엔딩 기록자
   긴장 11종 · 유머 9종 · 잡동사니 보상 9종 · 칭호 사건 5종 · 만든 물건 4개
   특별 이야기 46/46편 · 칭호 25개 (물때 아는 사람, 이모의 친구, 퇴근시킨 사람)
