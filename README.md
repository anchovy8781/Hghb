...
길에서 **같이 걸을 사람**을 만나고, 시끄럽게 다니면 **쫓는 사람**이 붙습니다.
...
| 동행 | 길에서 만난 **여덟 중 하나**와 같이 걷는다. 그 사람이 아는 일은 당신도 할 수 있게 되고, 신뢰가 쌓이면 전용 장면이 열린다 |
| 쫓김 | 총을 쓸수록 눈금이 오른다. 눈금마다 **네 단계**로 찾아온다 |
...
혼자 걷는 게임이었는데, 이제 길에서 **같이 가자는 사람**을 만납니다. 여덟 명 있습니다.
한 여정에 한 사람만 데리고 다닙니다.

| 사람 | 아는 것 | 어디서 만나는가 |
|---|---|---|
| **구** · 말 없는 짐꾼 | 근력 | 자갈치 뒤편에서 쌀자루를 여덟 번 지고 오르던 사람 |
| **미선** · 약을 아는 사람 | 응급처치 | 안 듣는 걸 알면서 재 탄 물을 발라 주던 사람 |
| **탁** · 전선을 만지는 아이 | 전기 기술 | 전봇대에 매달려 제값을 안 받던 열다섯 |
| **배 노인** · 물때를 아는 사람 | 항해술 | 배도 없이 방파제에서 물때를 보던 사람 |
| **연희** · 셈이 밝은 사람 | 회계학 | 시장 한복판에서 남의 셈이 틀렸다고 소리치던 사람 |
| **말코** · 밤에 보는 사람 | 야간 시야 | 불도 안 켜고 어둠 속에 서 있던 사람 |
| **정** · 다 듣는 사람 | 독해 | 십팔 년 동안 저녁 일곱 시를 한 번도 안 놓친 사람 |
| **홍** · 총을 아는 사람 | 사격술 | 하루에 한 발만 쏘기로 정해 둔 사람 |

**그 사람이 아는 일은 당신도 할 수 있게 됩니다.** 없던 능력이면 Lv.1이 생기고,
이미 아는 일이면 한 단계 깊어집니다. 구와 걸으면 완력이 필요한 갈래가 열리고,
말코와 걸으면 밤길이 열립니다. 누구와 걷느냐로 판이 달라집니다.

**신뢰는 말이 아니라 거리로 오릅니다.** 같이 55페이지를 걸을 때마다 한 칸씩,
세 칸까지 오릅니다. 이야기 안에서도 「등을 맡기고 앞만 본다」 「먹을 것을 반으로 자른다」 같은
동행자 전용 갈래를 고르면 오릅니다. 이런 갈래가 **이야기 205개**에 붙어 있습니다.

- **한 칸** — 존댓말을 씁니다. 길에서 툭툭 한마디씩 합니다.
- **두 칸** — 하는 말이 달라지고, 「위험한 쪽을 내가 맡는다」 같은 깊은 갈래가 열립니다.
- **세 칸** — 그 사람이 여태 안 하던 이야기를 합니다. 여덟 명 각자 다른 장면입니다.
  구가 지고 다니던 돌 스물세 개, 미선이 못 고친 사람 마흔한 명, 탁이 켜고 싶은 가로등 열두 개,
  배 노인이 못 닫은 조타실 문, 연희 아버지가 못 채운 장부 마지막 줄,
  말코가 혼자 빠져나온 문틀, 정이 못 적은 나흘, 홍의 빈 탄피 스물아홉 개.

그리고 **신뢰가 두 칸을 넘으면, 당신이 죽을 자리에서 대신 맞아 줍니다.**
의약품도 주사기도 부적도 다 떨어졌을 때만 일어나고, 한 여정에 한 번뿐입니다.
그 뒤로는 혼자 걷고, 마지막 장에 그 사람 이름이 남습니다.

기록실에 **누구와 걸어 봤는지**가 여정을 넘어 쌓입니다. 아직 못 만난 사람은 ??? 로 뜹니다.

## 쫓는 것

총을 쏘면 소리가 납니다. 소리는 사람을 부릅니다.
**총이 필요한 갈래를 고르거나 탄을 태울 때마다 「쫓김」 눈금이 오릅니다.**
한 발도 안 쏘고 끝까지 가면 이 이야기는 한 번도 안 나옵니다.

| 눈금 | 오는 것 | 어떻게 넘기는가 |
|---|---|---|
| 2 | 세는 사람이 묻고 갑니다 | 값을 미리 치르거나, 조용히 다니겠다고 말하거나 |
| 5 | 셋이 길을 막습니다 | 총을 내주거나, 다 털어 주거나, 뚫거나, 뛰거나 |
| 9 | 벽에 이름이 붙습니다 | 종이를 떼거나, 제 값을 제가 내거나 |
| 14 | 밤에 데리러 옵니다 | 값만큼 일하거나, 저쪽 셈을 고쳐 주거나, 창으로 나가거나 |

**둘이 다니면 값이 반으로 줍니다.** 2단계와 4단계에는 동행자가 있어야만 열리는 갈래가 있습니다.
"도망갈 사람은 혼자 다닙니다"가 저쪽 논리입니다.
...
- **미션** — 셋이 한 번에 붙고, **갱신**을 누르면 새로 뽑힙니다. **34종**이 있고 각각 3단계입니다.
...
- **상점** — 쿠키로 **장편 이야기 아홉 편**을 삽니다. 산 이야기는 켜고 끌 수 있고,
  **켜 둔 편만** 다음 여정에 끼어듭니다.
- **우편함** — 편지가 **열 통** 옵니다. 받으면 쿠키가 들어옵니다.
  첫 편지에 **쿠키 50,000개**가 들어 있으니, 아홉 편을 처음부터 다 살 수 있습니다.
  나머지 아홉 통은 시작 사연 · 장편 · 동행 · 쫓김 · 종장에서 갈리는 끝을 안내하는 편지입니다.
...
- **동행자 8명** — 길에서 만나 같이 걷는다. 능력을 나눠 주고, 신뢰가 차면 자기 이야기를 하고, 마지막에는 대신 맞아 준다.
- **추격 4단계** — 총을 쓴 만큼 눈금이 오르고, 눈금마다 찾아온다.
...
`tools/validate.mjs` 는 템플릿과 본편이 참조하는 **능력 / 아이템 / 세력 / 연결 사건 / 엔딩 / 동행자 / 치환자**가
...
또, 동행자와 추격 이야기에는 따로 거는 규칙이 있다.

- 동행자에게 **조건 없이 합류할 길**이 없으면 못 만나고 지나칠 수 있다 → 오류
- 추격 장면에 **조건 없는 선택지**나 **쫓김을 줄일 길**이 없으면 막힌다 → 오류
- 신뢰 조건은 1~3 사이여야 하고, 동행 조건 없이 혼자 붙어 있으면 안 된다 → 오류

실제로 이 규칙에 탁의 합류 장면(조건이 다 붙어 있었다)과
추격 2단계(빈손이면 아무것도 못 고르는 상태)가 걸려서 고쳤다.
