...
가는 길에 손으로 쓴 **특별 이야기 102편**이 판마다 다른 순서로 끼어들고,
...
| 가젯 | 능력 **55종**과 아이템 **3,613종**을 하나로 취급 |
...
| 특별 이야기 | 손으로 쓴 단편·중편 **102편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
- 결과: **생성 2,623종 + 손으로 쓴 990종 = 3,613종**
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 102편을 통째로 셔플해 두고,
...
- **특별 이야기 102편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
2. **슬롯 조합** — 구역 20 · 장소 52 · 인물 이름 1,200 · 유형 16 · 특징 24 · 위협 16 · 아이템 3,613 을 각각 별도의 덱에서 뽑아 끼운다.
