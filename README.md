...
가는 길에 손으로 쓴 **특별 이야기 76편**이 판마다 다른 순서로 끼어들고,
...
| 특별 이야기 | 손으로 쓴 단편·중편 **76편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
- **특별 이야기 76편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
1. **템플릿 덱** — 사건 템플릿 234종을 비복원으로 뽑는다. 최근 **32개** 안에 나온 사건은 다시 안 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
...
템플릿 234 · 도입 변형 702 · 선택지 1120

시드 100  · 1203p · 본문 43.6만자 · 엔딩 재판
시드 1077 · 1203p · 본문 43.6만자 · 엔딩 침묵
시드 2054 · 1203p · 본문 43.2만자 · 엔딩 복수
시드 3031 · 1203p · 본문 43.2만자 · 엔딩 기록자
시드 4008 · 1203p · 본문 43.3만자 · 엔딩 복수
시드 4985 · 1203p · 본문 43.3만자 · 엔딩 방송
