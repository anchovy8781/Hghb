...
가는 길에 손으로 쓴 **특별 이야기 86편**이 판마다 다른 순서로 끼어들고,
거기서 얻은 **칭호**가 한참 뒤에 되돌아온다.
미션으로 모은 **쿠키**로 상점에서 **장편 이야기 4편**을 사서 여정에 얹을 수 있다.
...
| 요소 | 내용 |
|---|---|
| 사연 | **부산-애프터에이틴** / **부산-코마** 중에 고른다. 도입부와 본편이 통째로 달라진다 |
| 자원 | 체력 · 멘탈 · 돈 각 **3칸**, 부산 특화로 **피폭 4칸** 추가 |
| 가젯 | 능력 **55종**과 아이템 **3,422종**을 하나로 취급 |
...
| 특별 이야기 | 손으로 쓴 단편·중편 **86편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
- 결과: **생성 2,623종 + 손으로 쓴 799종 = 3,422종**
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 86편을 통째로 셔플해 두고,
...
새 여정을 시작할 때 **어떤 사람으로 시작할지**를 고릅니다. 도입부와 본편이 통째로 달라집니다.
...
- **미션** — 셋이 한 번에 붙고, **갱신**을 누르면 새로 뽑힙니다. 16종이 있고 각각 3단계입니다.
...
- **상점** — 쿠키로 **장편 이야기**를 삽니다. 산 이야기는 켜고 끌 수 있고,
  **켜 둔 편만** 다음 여정에 끼어듭니다.
- **우편함** — 편지가 옵니다. 받으면 쿠키가 들어옵니다.
  첫 편지에 **쿠키 50,000개**가 들어 있으니, 장편 넷을 처음부터 다 살 수 있습니다.

## 장편 이야기 4편

특별 이야기가 장면 두셋짜리 단편이라면, **장편**은 한 여정의 한 축을 통째로 차지합니다.
상점에서 사서 켜 두면 정해진 페이지에서 시작되고, 그 뒤로는 **장면이 하나씩 이어집니다.**
끝에는 전용 엔딩 장면이 붙고, 고유 아이템이 남습니다.

| 장편 | 값 | 장면 | 무슨 이야기인가 | 엔딩 |
|---|---|---|---|---|
| **해운대 랜드마크 타워** | 150🍪 | 30 | 1층에서 101층까지 **직접 올라갑니다.** 계단은 3층씩, 아직 도는 엘리베이터를 타면 5층씩. 상가 → 사무 → 호텔 → 주거 → 기계층 → 고급 주거 → 전망대 → 옥상으로 층마다 성격이 바뀌고, 층마다 다른 사건과 선택지가 붙습니다. **의약품이 곳곳에 있습니다** — 없으면 위층까지 못 갑니다 | 「가장 높은 자리」 |
| **일광광산** | 150🍪 | 5 | 갱도 삼십 미터 아래. 들어가는 것보다 나오는 것이 어려운 자리 | 「삼십 미터」 |
| **낙동강의 기억** | 150🍪 | 5 | 강은 그날에도 안 멈췄습니다. 상류에서 떠내려온 것들의 이야기 | 「흘러가는 것」 |
| **뉴클리어** | 180🍪 | 5 | **왜 그날 두 발이 떨어졌는가.** 그 결정에 관여한 사람들과, 삼 분 동안 벌어진 일 | 「삼 분」 |

타워는 층마다 **의약품·부품·기록**이 흩어져 있고, 막힌 층·무너진 계단·바람 부는 옥상에서
매번 다른 값을 치릅니다. 101층에는 이십 년째 매일 한 줄씩 적고 있는 사람이 있습니다.

장편에서만 나오는 아이템이 **25종** 있습니다.
「타워 관리 일지」 「101층 열쇠」 「광맥 표본」 「낙동강 수위 기록」 「그날의 사진」 「삼 분 기록」
「병동 기록지」 「병동 팔찌」 「선량계」 …
...
- **장편 4편** — 상점에서 사서 켜 둔 것만. 정해진 페이지부터 장면이 하나씩 이어지고 전용 엔딩으로 끝난다.
- **특별 이야기 86편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
- **메인 메뉴** — 게임 시작(사연 선택) / 이어하기, 기록실(여정·특별 이야기·칭호), 엔딩 수집, 수집한 이야기, 상점, 미션, 우편함, 도움말.
...
1. **템플릿 덱** — 사건 템플릿 248종을 비복원으로 뽑는다. 최근 **32개** 안에 나온 사건은 다시 안 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
2. **슬롯 조합** — 구역 20 · 장소 52 · 인물 이름 1,200 · 유형 16 · 특징 24 · 위협 16 · 아이템 3,422 를 각각 별도의 덱에서 뽑아 끼운다.
