...
1. **템플릿 덱** — 사건 템플릿 240종을 비복원으로 뽑는다. 최근 **32개** 안에 나온 사건은 다시 안 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
