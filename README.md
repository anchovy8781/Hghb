...
가는 길에 손으로 쓴 **특별 이야기 9편**이 끼어들고, 거기서 얻은 **칭호**가 한참 뒤에 되돌아온다.
...
한 판은 **1,200페이지**이고, 본문은 약 **30만 자**입니다. (짧은 페이지 5,000장보다 읽는 분량이 많습니다.)
...
| 특별 이야기 | 정해진 페이지에 손으로 쓴 단편·중편 9편이 끼어든다. 끝내면 열쇠 아이템과 **칭호**가 남는다 |
...
- 결과: **생성 2,623종 + 손으로 쓴 117종 = 2,740종**
...
정해진 페이지에 닿으면 진행 중이던 이야기를 밀어내고 끼어들고, 장면 서너 개가 이어집니다.
화면 왼쪽 위 태그가 금색 「특별 이야기」로 바뀝니다.

| 편 | 페이지 | 이야기 | 남는 것 |
|---|---|---|---|
| 부산 아파트단지 | 110p | 규칙으로 굴러가는 다섯 동. 물탱크 위에서 사람이 하나 떨어졌다 | 관리비 영수증 · 「민원 처리반」 「입 무거운 사람」 |
| 부산지하철 | 200p | 이십 년째 멈춰 있는 막차와, 그날 스무 명 중 열아홉 번째 | 막차 승차권 · 「열아홉 번째 사람」 |
| 부산스러운 아침 | 290p | 아침마다 국을 끓이는 사람과, 이 빠진 그릇 하나 | 국밥 그릇 · 「단골」 |
| 부산진구 래퍼 「정상수소」 | 380p | 옥상 위의 랩 대결. 심판은 없고 판정은 웃음소리다 | 마이크 · 「부산진구 챔피언」 |
| 부산시청 난동 | 470p | 아무 힘도 없는 직인 하나를 두고 벌어지는 난동 | 시청 직인 · 「민원 중재인」 |
| 부산울산경주 순회공연 | 570p | 날짜 칸이 비어 있는 포스터를 들고 세 도시를 도는 사람들 | 순회공연 포스터 · 「순회 단원」 |
| 부산 알프스 | 680p | 낮에는 낮은 산, 해가 넘어가면 높아지는 산 | 산장 열쇠 · 「산 사람」 |
| 부산 미군기지 | 790p | 이십 년째 잠긴 창고와, 이름표 자리가 다른 나라 글자인 군장 | 미군 군장 · 「문을 연 사람」 |
| 부산 폐공장단지 | 900p | 아무도 안 시켰는데 아직 돌아가는 라인 | 공장 마스터키 · 「퇴근시킨 사람」 |
...
- 특별 이야기를 **4편 이상** 지나오면, 모닥불 앞자리가 당신을 위해 비워집니다.

특별 이야기를 **6편 이상** 본 채로 종장에 닿으면 전용 엔딩 「기록자」가 열립니다.
...
- **특별 이야기 9편** — 110p부터 900p까지, 정해진 자리에서 끼어든다.
- **메인 메뉴** — 게임 시작 / 이어하기, 기록실(여정·특별 이야기·칭호), 엔딩 수집, 도움말.
- **종장** — 해운대 지하 벙커. 방송 / 복수 / 침묵 / 재판 / 불, 그리고 특별 이야기를 6편 넘게 본 사람에게만 열리는 기록자.
...
1. **템플릿 덱** — 사건 템플릿 117종을 비복원으로 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
2. **슬롯 조합** — 구역 20 · 장소 52 · 인물 이름 1,200 · 유형 16 · 특징 24 · 위협 16 · 아이템 2,740 을 각각 별도의 덱에서 뽑아 끼운다.
...
```
$ node tools/simulate.mjs 2 700
템플릿 117 · 도입 변형 351 · 선택지 421

시드 700 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1141 · 중복 0 · 본문 30.3만자 · 엔딩 재판
   긴장 11종 · 유머 9종 · 잡동사니 보상 10종 · 칭호 사건 5종 · 만든 물건 11개
   특별 이야기 9/9편 · 칭호 9개 (입 무거운 사람, 열아홉 번째 사람, 단골)
시드 1677 · 1203p · 10장까지 · 장면 1203 · 고유 도입 1141 · 중복 0 · 본문 30.2만자 · 엔딩 기록자
   긴장 12종 · 유머 10종 · 잡동사니 보상 11종 · 칭호 사건 5종 · 만든 물건 11개
