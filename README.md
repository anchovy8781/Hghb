...
가는 길에 손으로 쓴 **특별 이야기 120편**이 판마다 다른 순서로 끼어들고,
...
| 가젯 | 능력 **55종**과 아이템 **3,638종**을 하나로 취급 |
...
| 특별 이야기 | 손으로 쓴 단편·중편 **120편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
- 결과: **생성 2,623종 + 손으로 쓴 1,015종 = 3,638종**
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 120편을 통째로 셔플해 두고,
...
큰 사건 말고 **사람이 살던 자리**를 여섯 편 새로 넣었습니다. 기본 사건 덱에 그냥 섞입니다.

| 사건 | 이 도시에서 그게 어떻게 굴러가는가 |
|---|---|
| **이발소** | 값은 머리 하나에 물 한 컵. 벽에 붙은 사진 스물세 장이 이 동네 명부입니다 |
| **목욕탕 굴뚝** | 닷새에 한 번 데웁니다. 나무를 많이 가져온 사람부터 뜨거운 물을 씁니다 |
| **계단 위 화분** | 열두 집이 사는 계단에 화분이 마흔둘. 서른은 안 돌아온 집 겁니다 |
| **남의 우산** | 벽에 스무 개가 걸려 있고 「쓰고 돌려놓을 것」이라고 적혀 있습니다 |
| **벽에 그은 키** | 문설주 금이 2015년에서 멈춰 있습니다. 새로 사는 애가 그 위에 안 긋습니다 |
| **물지게** | 우물이 밑에 있고 집이 삼백 채 위에 있습니다. 왕복 사십 분입니다 |
| **도시락** | 아침에 맡기고 점심에 누가 나릅니다. 나르는 사람은 값 대신 도시락 하나를 받습니다 |
...
- **특별 이야기 120편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
1. **템플릿 덱** — 사건 템플릿 298종을 비복원으로 뽑는다. 최근 **32개** 안에 나온 사건은 다시 안 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
2. **슬롯 조합** — 구역 20 · 장소 52 · 인물 이름 1,200 · 유형 16 · 특징 24 · 위협 16 · 아이템 3,638 을 각각 별도의 덱에서 뽑아 끼운다.
