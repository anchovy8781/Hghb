...
가는 길에 손으로 쓴 **특별 이야기 91편**이 판마다 다른 순서로 끼어들고,
거기서 얻은 **칭호**가 한참 뒤에 되돌아온다.
미션으로 모은 **쿠키**로 상점에서 **장편 이야기 7편**(장면 20~30개짜리)을 사서 여정에 얹을 수 있다.
...
| 요소 | 내용 |
|---|---|
| 사연 | 게임을 시작하면 **맨 처음 장면에서** 고른다. **애프터에이틴** / **코마** / **언어치브드 메리지** 셋. 도입부와 본편이 통째로 달라진다 |
| 자원 | 체력 · 멘탈 · 돈 각 **3칸**, 부산 특화로 **피폭 4칸** 추가 |
| 가젯 | 능력 **55종**과 아이템 **3,518종**을 하나로 취급 |
...
| 특별 이야기 | 손으로 쓴 단편·중편 **91편**. 순서와 페이지를 판마다 새로 섞고, 한 여정에 같은 편은 두 번 안 나온다 |
...
- 결과: **생성 2,623종 + 손으로 쓴 895종 = 3,518종**
...
**나오는 순서와 페이지는 판마다 새로 섞입니다.** 여정을 시작할 때 91편을 통째로 셔플해 두고,
...
- **상점** — 쿠키로 **장편 이야기 일곱 편**을 삽니다. 산 이야기는 켜고 끌 수 있고,
  **켜 둔 편만** 다음 여정에 끼어듭니다.
- **우편함** — 편지가 옵니다. 받으면 쿠키가 들어옵니다.
  첫 편지에 **쿠키 50,000개**가 들어 있으니, 일곱 편을 처음부터 다 살 수 있습니다.

## 장편 이야기 7편

특별 이야기가 장면 두셋짜리 단편이라면, **장편은 스무 장면이 넘습니다.**
상점에서 사서 켜 두면 정해진 페이지에서 시작되고, 그 뒤로 장면이 하나씩 이어집니다.
끝에는 전용 엔딩 장면이 붙고, 고유 아이템이 남습니다. 일곱 편을 다 켜면 한 여정에 **장면 154개**가 더 붙습니다.
...
- **장편 7편** — 상점에서 사서 켜 둔 것만. 스무 장면 넘게 이어지고 전용 엔딩으로 끝난다.
- **특별 이야기 91편** — 판마다 다른 순서로, 무작위 간격으로 끼어든다.
...
1. **템플릿 덱** — 사건 템플릿 270종을 비복원으로 뽑는다. 최근 **32개** 안에 나온 사건은 다시 안 뽑는다. 가중치로 장수를 늘리지 않기 때문에 특정 사건만 몇 배씩 나오는 일이 없고, 최근 10개는 후보에서 아예 빠진다.
2. **슬롯 조합** — 구역 20 · 장소 52 · 인물 이름 1,200 · 유형 16 · 특징 24 · 위협 16 · 아이템 3,518 을 각각 별도의 덱에서 뽑아 끼운다.
